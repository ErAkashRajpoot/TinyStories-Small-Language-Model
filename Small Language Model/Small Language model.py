# -*- coding: utf-8 -*-
"""Credits to Vizuara AI Labs Small Language Model Scratch workshop


# Introduction

My attempt Small Language Model (SLM) from scratch. Tried to keep the parameter size to 50-60 million.
